...
public class GroupsModel {
    ...
    public static List getGroups() {
        ...
        try {
            ...
            //get post data
            Query q = session.createQuery("From Groups");
            //q.setMaxResults(2);
            ...
            if (list.size() > 0) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    qu.setParameter("id", ((pojos.Groups) list.get(i)).getCreaterId());
                    List list2 = qu.list();
                    pojos.Groups g = (pojos.Groups) list.get(i);
                    g.setCreaterUser((pojos.Users) list2.get(0));
    ...
    public static boolean deleteGroup(int id) {
        ...
        try {
            ...
            pojos.Groups g;
            g = (pojos.Groups) session.get(pojos.Groups.class, id);
            if (!(g == null)) {
                session.delete(g);
            } else {
                return false;
    ...
    public static boolean createGroup(pojos.Groups group) {
        Session session = Controller.getSessionFactory().openSession();
        Transaction tx = null;
        int id = 0;
        try {
